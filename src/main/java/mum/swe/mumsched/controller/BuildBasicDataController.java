...
public class BuildBasicDataController {
	...
	private void generateFaculties() {
		...
		// CS 583 Atificial Intelligence
		Course CS583 = new Course();
		CS583.setCode("CS583");
		CS583.setName("Atificial Intelligence");
		CS583.setDescription("");
		courseService.save(CS583);
		
		// CS 584 Deep Learning
				Course CS584 = new Course();
				CS584.setCode("CS584");
				CS584.setName("Deep Learning");
				CS584.setDescription("");
				courseService.save(CS584);
				
				// CS 585 Enterprise System
				Course CS585 = new Course();
				CS585.setCode("CS585");
				CS585.setName("Enterprise System");
				CS585.setDescription("");
				courseService.save(CS585);
		...
		nolle.setMonthEnums(new ArrayList<MonthEnum>() {
			{
				add(MonthEnum.February);
				add(MonthEnum.March);
				add(MonthEnum.April);
		...
		nolle.setNumberOfSectionPerEntry(2);
